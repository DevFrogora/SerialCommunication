...
public class SerialCommuncation
{
    ...
    public static void Main(String[] args)
    {
        ...
        try
        {
            ...
            while (true)
            {
                Console.WriteLine("1) Send  2)Continuous Send  3) Read 4) Continuous Read");
                ...
                switch (intTemp)
                {
                    ...
                    case 3:
                        ...
                        incoming_Buffer = _serialPort.ReadLine();
                        Console.Write(incoming_Buffer);
                        break;
                    ...
                    case 4:
                        ...
                        while (true)
                        {
                            incoming_Buffer = _serialPort.ReadExisting();
                            if (incoming_Buffer.Equals("@"))
                            {
                                break;
                            }
                            Console.Write(incoming_Buffer);
